...
const HomepageHeroSection = () => {
  return (
    <div className="w-[50%] mx-auto flex flex-col justify-center items-center">
      <h1 className="text-[50px] font-bold text-center">Understanding NYC</h1>

      <h1 className="px-5 text-[#00a6ae] text-[50px] font-bold text-center">Neighborhoods</h1>

      <h1 className="text-[50px] font-bold text-center">Through Community Voice</h1>

      <p className="text-center pt-8 text-gray-500 font-medium">
        Empowering residents, politicians, and government workers with data-driven insights about neighborhood safety,
        cleanliness, and quality of life across New York City.
      </p>
